                   ...
                   <tr>
                        ...
                        {{-- <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <a class="dropdown-item" href="{{ route('ppid.laporan.pending',$l->id) }}">Pending</a>
                                    <a class="dropdown-item" href="{{ route('ppid.laporan.proses',$l->id) }}">Proses</a>
                                    <a class="dropdown-item" href="{{ route('ppid.laporan.verifikasi',$l->id) }}">Verifikasi</a>
                                    <a class="dropdown-item" href="{{ route('ppid.laporan.complete',$l->id) }}">Complete</a>
                                </div>
                            </div>
                        </td> --}}
                        <td>
                        ...
                        <td>
                            <div class="btn-group-vertical">
                                <a class="btn btn-primary btn-sm" href="{{ route('ppid.laporan.edit',$l->id) }}"><i class="fas fa-send"></i> Kirim</a>
                                <a class="btn btn-success btn-sm" href="{{ route('ppid.laporan.edit-status', $l->id) }}"><i class="fas fa-clipboard-check"></i>  Verif</a>
                                <a class="btn btn-info btn-sm" href="{{ route('ppid.laporan.detail', $l->id) }}"><i class="fas fa-eye"></i>  View</a>
                                <button href="{{route('ppid.laporan.destroy', $l->id)}}" class="btn btn-danger btn-sm" id="delete"><i class="fas fa-trash"></i> Hapus</button>
                            </div>
                        </td>
                   </tr>
                @endforeach
