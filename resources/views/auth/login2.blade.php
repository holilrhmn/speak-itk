...
@section('content')
<img class="wave" src="{{ asset('login-itk/img/wave2-01.png') }}">
    <div class="container">
        <div class="img">
            <img src="{{ asset('login-itk/img/bg2-01.svg') }}">
        </div>
        <div class="login-content">
            <form method="POST" action="{{ route('login') }}">
                @csrf
                <img src="{{asset('login-itk/img/logo-itk.png')}}">
                ...
                <button type="submit" class="btn1">
                    <div class="text-light">Masuk</div>
                </button>
